...
Dependence is logical implication, requirement to rebuild all downstream projects that depend on a modified file (in the upstream project), directly or indirectly.
...
This is correct for static libraries (and for static DLLs) - but INCORRECT for dynamic DLL loading.

As a result, new user may have to modify default References in the cases listed below.
